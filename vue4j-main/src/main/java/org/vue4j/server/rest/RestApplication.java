...
public class RestApplication extends ResourceConfig {
    ...
    public RestApplication(@Context ServletContext ctx) throws Exception {
        this((Vue4J) ctx.getAttribute("vue4j"));
    }
     ...
     * </pre>
     *
     * @param vue4j OpenSilex instance
     * @throws Exception If any initialization error occured for Jersey Rest Application
     */
    public RestApplication(Vue4J vue4j) throws Exception {
        this.vue4j = vue4j;
...
//
//        try {
//            beanConfig.setVersion(vue4j.getModuleByClass(ServerModule.class).getOpenSilexVersion());
...
//        return vue4j.getModulesImplementingInterface(APIExtension.class);
//    }
    /**
...
//                bind(vue4j).to(Vue4J.class);
//
//                // Make every module injectable
//                for (OpenSilexModule module : vue4j.getModules()) {
